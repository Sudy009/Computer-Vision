...
int main()
{
	...
	// (50, 40)위치를 특정 색상으로
	/*Image[40 * W * 3 + 50 * 3] = 0;
	Image[40 * W * 3 + 50 * 3 + 1] = 0;
	Image[40 * W * 3 + 50 * 3 + 2] = 255;*/ //색상의 순서는 반대로 bgr이다
	/*for (int i = 0; i < W; i++) {
		FillColor(Image, i, 200, W, H, 0, 255, 255);//위의 코드의 역할을 하는데 rgb의 순서이다
	}*/
	...
	//		Image[a * W * 3 + i * 3 + 1] = (BYTE)(0 * (1.0 - wt)); // Green
